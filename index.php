...
<html>
	...
	<body id="myPage">
		...
		<div class="w3-container w3-padding-64 w3-center" id="team">
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				foreach($Hostels as $key => $hostel) {
						...
						echo	"<img class=\"d-block w-100 hostel\" src=\"hostelImage/$hostel[HOSTEL_pic1]\" data-toggle=\"modal\" data-target=\"#exampleModalLong$hostel[HOSTEL_ID]\" alt=\"First slide\" data-id=\"$hostel[HOSTEL_ID]\" style=\"height: 25em;\">";
						echo	"<div class=\"carousel-caption d-block d-md-block\">";
						echo		"<h5>$hostel[HOSTEL_name]</h5>";
						echo		"<p>Rating: $hostel[HOSTEL_rating]</p>";
						echo	"</div>";
						echo "</div>";
					
						// hold location data for javascript to put into modal
						echo "<input name=\"hostelLat$hostel[HOSTEL_ID]\" id=\"hostelLat$hostel[HOSTEL_ID]\" value=\"$hostel[HOSTEL_latitude]\" type=\"hidden\">";
						echo "<input name=\"hostelLong$hostel[HOSTEL_ID]\" id=\"hostelLong$hostel[HOSTEL_ID]\" value=\"$hostel[HOSTEL_longitude]\" type=\"hidden\">";
					
					// Generate new modal for each hostel based on search string
					echo "<div class=\"modal fade\" id=\"exampleModalLong$hostel[HOSTEL_ID]\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\" style=\"text-align: left;\">";
					echo	"<form action=\"saveHostel.php\" method=\"post\" class=\"modal-dialog\" role=\"document\">";
					echo		"<div class=\"modal-content\">";
					echo			"<div class=\"modal-header\">";
					echo				"<h5 class=\"modal-title\">$hostel[HOSTEL_name]</h5>";
					echo				"<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">";
					echo					"<span aria-hidden=\"true\">&times;</span>";
					echo				"</button>";
					echo			"</div>";
					echo			"<div class=\"modal-body\">";
					echo				"<div id=\"map$hostel[HOSTEL_ID]\" style=\"height: 200px; width: 100%;\"></div>";
					echo				"<div class=\"w3-container w3-padding-64 w3-center\" id=\"team\">";
					echo					"<img src=\"hostelImage/$hostel[HOSTEL_pic1]\" style=\"width: 100%;\"></img>";					
					echo				"</div>";
					echo				"<div class=\"panel-group\">";
					echo					"<div class=\"panel panel-default\">";
					echo						"<div class=\"panel-heading\">State</div>";
					echo						"<div class=\"panel-body\">$hostel[HOSTEL_state]</div>";
					echo					"</div>";
					echo					"<div class=\"panel panel-default\">";
					echo						"<div class=\"panel-heading\">City</div>";
					echo						"<div class=\"panel-body\">$hostel[HOSTEL_city]</div>";
					echo					"</div>";
					echo					"<div class=\"panel panel-default\">";
					echo						"<div class=\"panel-heading\">Price</div>";
					echo						"<div class=\"panel-body\">$hostel[HOSTEL_price]</div>";
					echo					"</div>";
					echo					"<div class=\"panel panel-default\">";
					echo						"<div class=\"panel-heading\">Description</div>";
					echo						"<div class=\"panel-body\">$hostel[HOSTEL_description]</div>";
					echo					"</div>";
					echo					"<div class=\"panel panel-default\">";
					echo						"<div class=\"panel-heading\">Rating</div>";
					echo						"<div class=\"panel-body\">$hostel[HOSTEL_rating]</div>";
					echo					"</div>";
					echo				"</div>";
					echo			"</div>";
					echo			"<div class=\"modal-footer\">";
					echo				"<input name=\"id\" id=\"id$hostel[HOSTEL_ID]\" value=\"$hostel[HOSTEL_ID]\" type=\"hidden\">";
					echo				"<input name=\"acctid\" id=\"acctid$hostel[HOSTEL_ID]\" value=\"\" type=\"hidden\">";
					...
					echo				"<a type=\"button\" class=\"btn btn-info\" id=\"url\" href=\"$hostel[HOSTEL_url]\" target=\"_blank\">Go to Hostel Site</a>";
					echo			"</div>";
					echo		"</div>";
					echo	"</form>";
					echo "</div>";
				...
				foreach($Hostels as $key => $hostel) {
						...
						echo	"<img class=\"d-block w-100 hostel\" src=\"hostelImage/$hostel[HOSTEL_pic1]\" data-toggle=\"modal\" data-target=\"#exampleModalLong$hostel[HOSTEL_ID]\" alt=\"$hostel[HOSTEL_name]\" data-id=\"$hostel[HOSTEL_ID]\" style=\"height: 25em;\">";
						echo	"<div class=\"carousel-caption d-block d-md-block\">";
						echo		"<h5>$hostel[HOSTEL_name]</h5>";
						echo		"<p>Rating: $hostel[HOSTEL_rating]</p>";
						echo	"</div>";
		...
		<!-- Container -->
		<div id="video">
			<iframe src="https://www.youtube.com/embed/ioYqFtr2D0Q" frameborder="0" allowfullscreen></iframe>
		</div>

		<!-- Adventure button container -->
		<form class="w3-center adventureCont" action="adventureResult.php" method="post">
			<h2 style="font-size: 42px">LIFE IS SHORT!<br>EXPLORE THE WORLD!</h2>
